...
final class HomepageViewData
{
    ...
    private function load(bool $preview): ?array
    {
        ...
        $sections = HomepageSection::query()
            ...
            ->with(['items' => fn ($query) => $query->with(['solution','product','industry'])->where('is_active', true)->orderBy('display_order')->orderBy('id')->limit(24)])
