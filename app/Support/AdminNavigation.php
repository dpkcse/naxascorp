...
class AdminNavigation
{
    ...
    public static function groups(): array
    {
        return [
            ...
            ['label' => 'Content', 'items' => array_merge([['label' => 'Solutions', 'route' => 'admin.solutions.index']], self::disabled(['Products', 'Industries', 'Capabilities', 'Work Process', 'Clients', 'Testimonials', 'Statistics']))],
