...
class AdminNavigation
{
    ...
    public static function groups(): array
    {
        return [
            ...
            ['label' => 'Content', 'items' => array_merge([['label' => 'Media Library', 'route' => 'admin.media.index'], ['label' => 'Solutions', 'route' => 'admin.solutions.index'], ['label' => 'Products', 'route' => 'admin.products.index'], ['label' => 'Industries', 'route' => 'admin.industries.index'], ['label' => 'Capabilities', 'route' => 'admin.capabilities.index'], ['label' => 'Work Process', 'route' => 'admin.work-processes.index'], ['label' => 'Clients', 'route' => 'admin.clients.index'], ['label' => 'Testimonials', 'route' => 'admin.testimonials.index'], ['label' => 'Statistics', 'route' => 'admin.statistics.index']])],
