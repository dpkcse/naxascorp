...
class AdminNavigation
{
    ...
    public static function groups(): array
    {
        return [
            ...
            ['label' => 'Content', 'items' => array_merge([['label' => 'Solutions', 'route' => 'admin.solutions.index'], ['label' => 'Products', 'route' => 'admin.products.index']], self::disabled([ 'Industries', 'Capabilities', 'Work Process', 'Clients', 'Testimonials', 'Statistics']))],
